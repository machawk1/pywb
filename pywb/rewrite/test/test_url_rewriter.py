...
>>> do_rewrite(r'https:\/\/some-other-site.com', '20101226101112/http://example.com/index.html', 'http://localhost:8080/')
'http://localhost:8080/20101226101112/https:\\\\/\\\\/some-other-site.com'
